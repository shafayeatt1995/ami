<template>
  <GeneralPage
    page_title="Streaks"
    class="streaks-page"
    page_description="The Streaks page is an accumulation of fixtures updated daily based on the Streaks and Trends of teams around the world with their respective betting markets Odds. Exclusive to Footy Amigo Pro users."
  >
    ...
    <b-skeleton-wrapper :loading="loading">
      <template #loading>
        <div class="streaks-table-page">
          <b-skeleton height="40px" width="250px" class="mx-auto text-center"></b-skeleton>
          <b-skeleton height="20px" width="400px" class="mx-auto mt-2 mb-4"></b-skeleton>
          <carousel
            :perPageCustom="[
              [0, 1],
              [768, 2],
          ...
          >
            ...
            >
              <div class="streaks-table">
                <h4 class="streaks-table-head streaks-table-row">
                  <b-skeleton height="20px"></b-skeleton>
                  <b-skeleton height="20px"></b-skeleton>
                  <b-skeleton height="20px"></b-skeleton>
                  <b-skeleton height="20px"></b-skeleton>
                </h4>
                <div class="streaks-table-row" v-for="skeletonIndex in 6" :key="'skeleton-' + skeletonIndex">
                  <b-skeleton height="55px"></b-skeleton>
                  <b-skeleton height="55px"></b-skeleton>
                  <b-skeleton height="55px"></b-skeleton>
                  <b-skeleton height="55px"></b-skeleton>
                </div>
