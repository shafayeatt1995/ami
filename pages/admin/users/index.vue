  ...
  <div>
    <b-row>
      <b-col cols="12">
        ...
        <div class="my-3">
          <footy-radio :options="user_types" v-model="user_type"></footy-radio>
        </div>

        <h4 class="my-3 text-capitalize">
          {{ users.length }} {{ user_type }} users found
        </h4>
        <b-table
          :items="users"
          class="my-4"
        ...
        <div v-if="change_expiry_mode" class="centered gap-10">
          ...
          >
            <template v-if="save_loading">
              Saving
              <b-spinner small variant="light" type="grow" class="ml-2">
              </b-spinner>
            </template>
