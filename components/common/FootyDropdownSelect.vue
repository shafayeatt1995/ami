  ...
  <div v-if="options && options.length">
    ...
    >
      <button
        ...
        :class="is_disabled ? 'dropdown_disabled' : ''"
      ...
      <div class="dropdown-body-wrapper" @mouseleave="collapsed = true">
        <label
          ...
          :class="check_circle_mode && selected === option.value ? 'selected-option' : ''"
        ...
        >
          ...
          <div class="dropdown-item-text">
            <IconCheck class="mr-2" v-if="check_circle_mode" />
            {{ option.text }}
...
<script>
import IconCheck from '~/static/images/icon/check-circle.svg';
export default {
