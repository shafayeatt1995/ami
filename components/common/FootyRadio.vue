  ...
  <div>
    ...
    >
      <div
        class="footy-radio"
        :class="[
          option.upgradeToPro ? 'footy-radio__upgrade-to-pro' : '',
          radioClass,
        ]"
        v-for="option in options"
        :id="'footy_radio_' + option.value"
      ...
      >
        ...
        <b-popover
          :target="'footy_radio_' + option.value"
          placement="bottom"
          v-if="option.upgradeToPro"
        >
