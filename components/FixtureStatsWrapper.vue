<template>
  <div class="fixture-wrapper mb-1">
    <div
      ...
      :class="is_live_mode ? 'is-live' : ''"
    >
      <FavoriteWrapper :fixture="fixture" v-if="!hideFavorite">
      </FavoriteWrapper>
      <TimerWrapper :is_live_mode="is_live_mode" :fixture="fixture">
      </TimerWrapper>
      <TeamsWrapper
      ...
      <CardsWrapper :is_live_mode="is_live_mode" :fixture="fixture">
      </CardsWrapper>
      ...
      <template v-if="is_live_mode">
        <LiveWrapper :fixture="fixture"> </LiveWrapper>
      </template>

      <div class="live-pre-wrapper">
        <template
          v-if="scroller == 'in_play_scroller' && is_live_mode && fixture.stats"
        >
      ...
      <ScrollWrapper
        ...
        v-if="scroller != 'in_play_scroller' && !is_live_mode"
      >
      </ScrollWrapper>
