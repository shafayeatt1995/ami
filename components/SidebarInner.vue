        ...
        <b-list-group>
          <b-list-group-item
            ...
            ><div class="sidebar-item-text">
              ...
              {{ sidebarItem.text }}
              <b-badge v-if="sidebarItem.new" variant="yellow" class="ml-2"
                >NEW</b-badge
              >
            </div>
          </b-list-group-item>
...
export default {
  ...
  computed: {
    sidebarItems() {
      if (!this.$store.getters.is_tester) {
        return this.sidebarItemsDefault.filter((item) => {
          return !item.tester_only;
        });
      }
      return this.sidebarItemsDefault;
    },
  },
};
</script>
