<template>
  <div class="todays-highlights page-content-box" style="height: 100%">
    <div
      class="highlight-text d-flex flex-md-row flex-column justify-content-between align-items-md-center align-items-start"
    >
      ...
      <template v-if="highlights">
        <b-col v-for="highlight in highlights" :key="highlight.id">
          <div class="highlight-box">
            ...
            <p class="count animate__animated animate__bounceIn" v-else>
              {{ highlight.count | formatNum }}
            </p>
  ...
  data() {
    return {
      highlights: [
        ...
        {subtitle: 'Matches', title: 'Live', id: 'live_games'},
        {subtitle: 'Picks', title: 'Today', id: 'picks'},
        {
          subtitle: 'Strategies',
          title: 'All time',
