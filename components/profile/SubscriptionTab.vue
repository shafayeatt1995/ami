    ...
    <section class="subscriptions" v-if="hasSubscription">
      ...
      >
        ...
        <div class="footy-modal-content">
          <div class="mb-3">By cancelling your Footy Amigo subscription...</div>
          <ul class="list-unstyled mb-3">
            <li>
              ❌ You will NOT be able to receive alerts to your Telegram
              anymore.
            </li>
            <li>❌ You will LOSE access to your created strategies.</li>
            <li>
              ❌ You will NOT be able to create new Prematch or Inplay
              Strategies.
            </li>
            <li>❌ You will have LIMITED access to the Bet Builder Page.</li>
            <li>
