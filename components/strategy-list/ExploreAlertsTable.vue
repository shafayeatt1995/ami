  ...
  <div class="explore-alerts-table">
    <template v-if="strategies.length">
      <div class="explore-alerts-table-head explore-alerts-table-row text-grey">
        ...
        <div>
          {{
            strategy_mode == 'preset-alerts'
              ? 'PICKS SENT'
              : strategy_type == 'pre-match-alerts'
              ? 'HIT RATE'
              : 'STRIKE RATE'
          }}
        </div>
      ...
      >
        ...
        <div class="hit-rate-item explore-alerts-table-item">
          ...
          <div
            ...
            v-if="strategy_mode == 'preset-alerts'"
          >
            {{ item.picks_sent }}
          </div>
          <div
            class="my-alerts-item-value"
            v-else-if="strategy_type == 'pre-match-alerts'"
          >
    ...
    <PromptModal
      v-model="is_import_prompt_shown"
...
export default {
  ...
  methods: {
    ...
    async promptImport(id) {
      this.is_import_prompt_shown = true;
      this.importId = id;
    },
  },
};
