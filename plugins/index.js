...
import FootyTabButton from '~/components/common/FootyTabButton.vue';
...
Vue.component('FootyTabButton', FootyTabButton);
...
function screenSize() {
  return window.screen.width > 1000 ? SCREEN_SIZE.DESKTOP : SCREEN_SIZE.MOBILE;
}
Vue.prototype.$screenSize = screenSize;
